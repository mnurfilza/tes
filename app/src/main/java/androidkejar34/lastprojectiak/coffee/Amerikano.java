...
public class Amerikano extends EspressoAcr {
    private TextView qt_txt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amerikano);


        gt_txt = (TextView) findViewById(R.id.gttext);
        qt_txt = (TextView) findViewById(R.id.quanttitis);
        ...
        ordered.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (qtt_txt <= 0 ||isEmpty(namedt)) {
                    Toast.makeText(Amerikano.this, "Input nama dan masukan jumlah pesanan ", Toast.LENGTH_SHORT).show();
                } else if (!isChar(namedt)) {
                    Toast.makeText(Amerikano.this, "Masukan Huruf saja pada kolom nama", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Amerikano.this, "Pesanan anda telah kami terima,Terima kasih "+namedt.getText().toString(),Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(Amerikano.this, MainActivity.class));
                    qtt_txt = 0;
                    gtot_txt = 0;
                    namedt.setText("");
                    displayPrice(0);
